...
function ContextFormChild() {
  const { allData, setAllData, setIsForm } = useContext(ParentFormContext);
        ...
        <div className=" grid grid-cols-3 gap-5 mx-5">
          ...
          <div className="grid grid-cols-3 gap-2 py-2">
            <div className="grid col-span-2 ">
              ...
              <div>
                <fieldset className=" items-center -mt-1 justify-center border border-gray-700 my-2 rounded-lg ">
                  <button
                    type="button"
                    className="h-4 bg-gray-200 px-2 text-sm flex items-center mx-2 my-[2px] py-[10px]"
                    onClick={() => {
...
export default ContextFormChild;
