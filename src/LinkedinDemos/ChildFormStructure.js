...
import ParentFormData, { ParentDataBase } from "./ParentFormData";

function ChildFormStructure() {
  const { alldata, setAllData } = useContext(ParentDataBase);
  console.log("allData as context",alldata);
...
export default ChildFormStructure;
